...
@section('title', 'CREATE ROOM PAGE')
            ...
            <div class="card"  style="background-color: rgba(255, 255, 255, 0.247)">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center text-primary">Create New Room</h3>
                    </div>
                    {{-- horizontal line --}}
                    <br>
                    {{-- room form --}}
                    <form action="{{route('create.room.function')}}" method="post" enctype="multipart/form-data">
                        @csrf
                          {{-- room image --}}
                        ...
                        <div class="form-group mb-3">
                            ...
                            class="form-control @error('roomDescription')  is-invalid @enderror">{{old('categoryDescription')}}</textarea>
