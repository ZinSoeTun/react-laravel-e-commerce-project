...
@section('title', 'CREATE DESIGNER PAGE')
...
<div class="container" style="height: 150vh">
    ...
    <div class="alert w-75 mx-auto" style="margin-top: 30px;background-color:rgba(13, 78, 13, 0.651)">
      ...
      <div class="alert w-75 mx-auto" style="margin-top: 30px;background-color:rgba(141, 8, 26, 0.87)">
        ...
        @endif
       {{-- designer create card --}}
       <div class="container-fluid">
        <div class="col-lg-6 offset-lg-3">
            <div class="card"  style="background-color: rgba(255, 255, 255, 0.247)">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center text-primary">Create New Designer</h3>
                    </div>
                    {{-- horizontal line --}}
                    <br>
                    {{-- designer form --}}
                    <form action="{{route('create.designer.function')}}" method="post" enctype="multipart/form-data">
                        @csrf
                          {{-- designer image --}}
                        ...
                        <div class="form-group mb-3">
                            ...
                            class="form-control @error('designerDescription')  is-invalid @enderror">{{old('categoryDescription')}}</textarea>
