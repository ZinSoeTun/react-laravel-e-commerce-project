        ...
        <div class="col-lg-6 offset-lg-3">
            <div class="card"  style="background-color: rgba(255, 255, 255, 0.247)">
                <div class="card-body">
                    ...
                    <br>
                    {{-- product form --}}
                    <form action="{{route('create.product.function')}}" method="post" enctype="multipart/form-data">
                        @csrf
                          {{-- product image --}}
                        ...
                        <div class="form-group mb-3">
                            ...
                            class="form-control @error('productDescription')  is-invalid @enderror">{{old('categoryDescription')}}</textarea>
